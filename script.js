...
var places = [
 [{ lat: 45.436794, lng: 12.333671 }, { country: 'ヴェネツィア', description: '「ヴェネツィアは5世紀にアドリア海の干潟に築かれた水上都市である。『アドリア海の女王』『水の都』などの別名を持つ。118もの小島からなり、『リアルト橋』など多くの橋で結ばれている。」', hint: '豪華なマスク（仮面）をつけて練り歩くカーニバルや、国際映画祭でも有名です。' }],
 ...
 [{ lat: 41.890160,  lng: 12.490480 }, { country: 'コロッセオ', description: '「『コロッセオ』は、長径188m、短径156m、高さ49mの巨大な円形闘技場です。皇帝ネロの黄金宮殿の庭園にあった人工池の跡地に建設され、西暦80年に完成しました。猛獣狩りや剣闘士の試合が行われ、ローマ市民の娯楽施設として親しまれました。」', hint: '巨大な楕円形の建物で、古代ローマ時代に作られた「闘技場」です。' }],
];
